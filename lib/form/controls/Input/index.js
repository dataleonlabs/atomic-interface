...
const Input = (props) => {
    const renderField = ({ field, form: { submitCount, errors } }) => (React.createElement(React.Fragment, null,
        wrapperInputGroup(React.createElement(StyledInputBootstrap, Object.assign({ placeholder: props.placeholder }, field, { invalid: submitCount > 0 && (errors[props.name] ? true : false) })), props),
    ...
    return (React.createElement(FormGroup, null,
        React.createElement(Control, Object.assign({}, props),
