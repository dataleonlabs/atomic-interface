...
const CheckBox = (props) => {
    const renderField = ({ field, form: { submitCount, errors } }) => (React.createElement(React.Fragment, null,
        React.createElement(CustomInput, Object.assign({}, field, props, { id: props.id || props.name, label: props.label, invalid: submitCount > 0 && (errors[props.name] ? true : false), type: 'checkbox' })),
