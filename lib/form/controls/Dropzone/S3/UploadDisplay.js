...
var UploadDisplay = /** @class */ (function (_super) {
    ...
    function UploadDisplay() {
        ...
        _this.renderFileUpload = function (_, i) {
            var fileName = (_this.props.fileName || _this.props.value);
    ...
    UploadDisplay.prototype.render = function () {
        var _a = this.props, uploadedFiles = _a.uploadedFiles, progress = _a.progress, value = _a.value, uploaded = _a.uploaded;
        // For edit value
        if (value && !uploadedFiles.length && !uploaded) {
            return (React.createElement("div", { className: "Dropzone " + (uploadedFiles.length ? "dropped" : "") }, this.renderFileUpload(null, 0)));
        }
