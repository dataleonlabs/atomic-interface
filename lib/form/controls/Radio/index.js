...
var Radio = function (props) {
    var renderField = function (_a) {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(reactstrap_1.CustomInput, __assign({}, field, props, { id: props.id || props.name, label: props.label, invalid: submitCount > 0 && (errors[props.name] ? true : false), type: 'radio' })),
