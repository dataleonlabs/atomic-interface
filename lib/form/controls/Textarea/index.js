...
var Textarea = function (props) {
    var renderField = function (_a) {
        var field = _a.field;
        return (react_1.default.createElement(style_1.StyledTextareaAutosize, __assign({ rows: Number(props.rows || 5), maxRows: Number(props.maxRows || 10), className: "form-control", placeholder: String(props.placeholder || '') }, field)));
    };
