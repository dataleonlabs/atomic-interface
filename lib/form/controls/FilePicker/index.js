...
var FilePicker = function (props) {
    ...
    var renderField = function (_a) {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(reactstrap_1.CustomInput, __assign({}, rest, { id: props.name, type: "file", invalid: submitCount > 0 && (errors[props.name] ? true : false), onChange: field.onChange, onBlur: field.onBlur })),
