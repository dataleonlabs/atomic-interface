...
const FilePicker = (props) => {
    ...
    const renderField = ({ field, form: { submitCount, errors } }) => (React.createElement(React.Fragment, null,
        React.createElement(FilePickerBootstrap, Object.assign({}, rest, { id: props.name, type: "file", invalid: submitCount > 0 && (errors[props.name] ? true : false), onChange: field.onChange, onBlur: field.onBlur })),
