...
var Text_1 = __importDefault(require("../../../../display/Text"));
var Button_1 = __importDefault(require("../../../../form/controls/Button"));
function getHeaders() {
    var headers = {
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement(style_1.StyledImageUploader, null,
                    React.createElement(style_1.StyledUploadBtnWrapper, { label: _this.props.label },
                        React.createElement(Button_1.default, { loading: _this.state.loading, outline: outline, block: block, color: color, disabled: (_this.state.loading || 0) > 0 ? true : false, size: size, icon: icon, id: id, style: style, type: 'button' },
                    ...
                    _this.state.error === true && (React.createElement(Text_1.default, null, _this.state.errorMessage)),
