    ...
    function Table() {
        ...
        _this.colonns = function () {
            ...
            if (_this.props.draggable === true) {
                columns.push(react_1.default.createElement(HeaderCell, { minimum: true, key: 'key-col-0' }));
            }
            // If selected row
            if (_this.props.selectable === true) {
                ...
                columns.push(react_1.default.createElement(HeaderCell, { width: "4%", key: 'key-selc-0' },
            ...
            react_1.default.Children.map(_this.props.children, function (child) {
                if (react_1.default.isValidElement(child)) {
                    ...
                    if (childProps && childProps.field) {
                        var column = _this.wrapperSortable(react_1.default.createElement(HeaderCell, __assign({ key: childProps.field, minimum: true }, childProps, { width: (childProps.width || _this.getDefaultWidth()) + "%" }), childProps.children || /* istanbul ignore next */ childProps.field), child);
                        columns.push(column);
                    }
                }
            });
        ...
        _this.cells = function (row) {
            ...
            if (_this.props.selectable === true) {
                ...
                cells.push(react_1.default.createElement(Cell, { width: "4%", key: 'key-cell-0' },
        ...
        _this.cellsDragable = function (row, snapshot, provided, index) {
            var cells = [];
            cells.push(react_1.default.createElement(style_1.DraggableCell, { minimum: true, key: "dnd-cell-" + index },
                react_1.default.createElement(style_1.DraggableContainer, __assign({ id: "dnd-" + index }, provided.dragHandleProps), "::")));
            // If selected row
            if (_this.props.selectable === true) {
                ...
                cells.push(react_1.default.createElement(style_1.DraggableCell, { key: 'key-drag-0', width: "4%", isDragging: snapshot.isDragging },
            ...
            react_1.default.Children.map(_this.props.children, function (child) {
                if (react_1.default.isValidElement(child)) {
                    ...
                    if (childProps && childProps.field) {
                        ...
                        var cell = (react_1.default.createElement(style_1.DraggableCell, __assign({ key: "dnd-cell-" + index + "-" + childProps.field, truncate: true }, childProps, { isDragging: snapshot.isDragging, width: (childProps.width || _this.getDefaultWidth()) + "%" }), cellValue));
                        cells.push(cell);
                    }
                }
            });
                ...
                react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement(react_beautiful_dnd_1.DragDropContext, { onDragEnd: this.onDragEnd },
                        react_1.default.createElement(TableBase, { scrollable: this.props.scrollable ? /* istanbul ignore next */ this.props.scrollable + "px" : /* istanbul ignore next */ undefined, size: this.props.rowSize === 'default' ? /* istanbul ignore next */ undefined : this.props.rowSize },
                            ...
                            (this.props.loading === true) ? react_1.default.createElement(loader_1.default, null) : (react_1.default.createElement(react_beautiful_dnd_1.Droppable, { droppableId: "droppable" }, function (provided, droppableSnapshot) {
                    ...
                    ((this.props.loading !== true) && (this.props.data.length === 0)) && (react_1.default.createElement(style_1.StyledNoContent, null, this.props.noContentIndication || 'Not found')),
                    contentPagination)));
        }
        return (react_1.default.createElement(ThemeProvider, null,
            react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(TableBase, { scrollable: this.props.scrollable ? /* istanbul ignore next */ this.props.scrollable + "px" : undefined, size: this.props.rowSize === 'default' ? /* istanbul ignore next */ undefined : this.props.rowSize },
                    ...
                    (this.props.loading === true) ? react_1.default.createElement(loader_1.default, null) : (react_1.default.createElement(Body, null, this.props.data.map(function (row, index) { return (react_1.default.createElement(style_1.StyledRow, { key: index, selected: _this.state.selected[row.id], striped: _this.props.striped && index % 2 === 0 }, _this.cells(row))); })))),
                ((this.props.loading !== true) && (this.props.data.length === 0)) && (react_1.default.createElement(style_1.StyledNoContent, null, this.props.noContentIndication || 'Not found')),
                contentPagination)));
    };
    Table.defaultProps = {
